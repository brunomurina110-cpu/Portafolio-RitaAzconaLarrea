    ...
    if (galleryContainer && typeof obrasDeArte !== 'undefined') {
        ...
        const renderGallery = (filterSerie) => {
            ...
            filteredObras.forEach(obra => {
                ...
                // Combine specs (tecnica + tamaño + año)
                ...
                if (obra.año) {
                    specsCombine = specsCombine ? `${specsCombine} | Año: ${obra.año}` : `Año: ${obra.año}`;
                }
                ...
                article.innerHTML = `
                    ...
                    <div class="card-info">
                        ...
                        ${obra.precio.toLowerCase().includes('no disponible') ? '' : `<button class="btn btn-action" onclick="openModal('${obra.imagen}', '${obra.titulo}', '${specsCombine}', '${obra.precio}', '${serieParam}')">Consultar</button>`}
                    </div>
                `;
...
function openModal(imageSrc, title, specs, price, serie = '') {
    ...
    if (price.toLowerCase().includes('no disponible')) {
